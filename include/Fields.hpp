...
class Fields {
  public:
     ...
     *
     */
    Fields(double _nu, double _dt, double _tau, int imax, int jmax, double UI, double VI, double UIN, double VIN, double PI, double TI = 0.0, double alpha = 0.0, double beta = 0.0, double gx = 0.0, double gy = 0.0);
